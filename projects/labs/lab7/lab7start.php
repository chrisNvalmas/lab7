...
class Factorial extends Operation {
  public function operate() {
    $value = 1;
    for ($i = 0; $i < $this->operand_1; $i++ ) {
      $value *= ($this->operand_1 - $i);
    }
    return $value;
  }
  public function getEquation() {
...
// Put the code for Part 2 here  \/
    ...
    else if(isset($_POST['fac']) && $_POST['fac'] == 'Factorial') {
...
<body>
  ...
  <form method="post" action="lab7start.php">
    <input class="startInput" type="text" name="op1" id="name" value="" />
    <input class="startInput" type="text" name="op2" id="name" value="" />
    <br/>
    <!-- Only one of these will be set with their respective value at a time -->
    <input class="Function" type="submit" name="add" value="Add" />  
    <input class="Function" type="submit" name="sub" value="Subtract" />  
    <input class="Function" type="submit" name="mult" value="Multiply" />  
    <input class="Function" type="submit" name="div" value="Divide" />  
    <input class="Function" type="submit" name="fac" value="Factorial" />  
    <input class="Function" type="submit" name="cube" value="Cube" />  
  </form>
</body>
</html>
